...
func TestBPlusTree_Size(t *testing.T) {
	...
	tree.Put([]byte("aac"), &data.LogRecordPos{Fid: 0, Offset: 0})
	tree.Put([]byte("abc"), &data.LogRecordPos{Fid: 0, Offset: 0})
	tree.Put([]byte("acc"), &data.LogRecordPos{Fid: 0, Offset: 0})
